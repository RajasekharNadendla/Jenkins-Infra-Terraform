...
resource "aws_key_pair" "sonar" {
 key_name   = "sonar"
  # you can paste the public key directly like this
  public_key = "ssh-rsa  Nadendla.Rajasekhar@Rajasekhar15-laptop"
# public_key = file("~/.ssh/tools.pub")
  # ~ means windows home directory
}
